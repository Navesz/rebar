...
São <!--n proofs.casos-->55<!--/n--> casos, um par por regra, e as <!--n rules.total-->23<!--/n--> regras estão cobertas:
...
Ele carrega <!--n mcp.artefato.regras-->26<!--/n--> regras de dois módulos, <!--n mcp.artefato.passos-->19<!--/n--> passos de portão e <!--n mcp.artefato.provas-->59<!--/n--> provas, expostos em <!--n mcp.ferramentas-->5<!--/n--> ferramentas.

## Mapa do repositório

| Caminho | O quê |
|---|---|
| `tooling/rebar-check/` | a régua de formato e seus <!--n proofs.casos-->55<!--/n--> casos de prova |

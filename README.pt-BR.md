...
São <!--n proofs.casos-->76<!--/n--> casos, um par por regra, e as <!--n rules.total-->23<!--/n--> regras estão cobertas:
...
Ele carrega <!--n mcp.artefato.regras-->40<!--/n--> regras de dois módulos, <!--n mcp.artefato.passos-->27<!--/n--> passos de portão e <!--n mcp.artefato.provas-->194<!--/n--> provas, expostos em <!--n mcp.ferramentas-->5<!--/n--> ferramentas.

## Mapa do repositório

| Caminho | O quê |
|---|---|
| `tooling/rebar-check/` | a régua de formato e seus <!--n proofs.casos-->76<!--/n--> casos de prova |

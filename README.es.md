...
Son <!--n proofs.casos-->68<!--/n--> casos, un par por regla, y las <!--n rules.total-->23<!--/n--> reglas están cubiertas:
...
Lleva <!--n mcp.artefato.regras-->27<!--/n--> reglas de dos módulos, <!--n mcp.artefato.passos-->25<!--/n--> pasos de compuerta y <!--n mcp.artefato.provas-->74<!--/n--> pruebas, expuestos en <!--n mcp.ferramentas-->5<!--/n--> herramientas.

## Mapa del repositorio

| Ruta | Qué |
|---|---|
| `tooling/rebar-check/` | la regla de formato y sus <!--n proofs.casos-->68<!--/n--> casos de prueba |

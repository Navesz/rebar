...
[![Compuerta](https://img.shields.io/badge/compuerta-<!--n verify.passos-->17<!--/n-->%20pasos-blue)](#la-compuerta)
...
antes que él, hoy con <!--n verify.passos-->17<!--/n--> pasos.

En orden: <!--n verify.lista-passos-->`hygiene` · `hooks` · `syntax` · `blocks` · `mcp-server` · `mcp` · `numbers` · `format` · `links` · `secret` · `secret-proofs` · `steps` · `proofs` · `generator-map` · `mcp-template` · `security` · `self`<!--/n-->
...
Lleva <!--n mcp.artefato.regras-->26<!--/n--> reglas de dos módulos, <!--n mcp.artefato.passos-->17<!--/n--> pasos de compuerta y <!--n mcp.artefato.provas-->58<!--/n--> pruebas, expuestos en <!--n mcp.ferramentas-->5<!--/n--> herramientas.

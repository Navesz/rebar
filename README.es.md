...
[![Compuerta](https://img.shields.io/badge/compuerta-<!--n verify.passos-->18<!--/n-->%20pasos-blue)](#la-compuerta)
...
npx github:Navesz/rebar novo padaria-do-ze   # empezar del lado correcto
```
...
Son <!--n proofs.casos-->55<!--/n--> casos, un par por regla, y las <!--n rules.total-->23<!--/n--> reglas están cubiertas:
...
| `npx github:Navesz/rebar novo <nombre>` | Empezar un proyecto ya con compuerta | Un solo preset: `site` |
...
antes que él, hoy con <!--n verify.passos-->18<!--/n--> pasos.

En orden: <!--n verify.lista-passos-->`hygiene` · `hooks` · `syntax` · `blocks` · `mcp-server` · `mcp` · `numbers` · `format` · `links` · `secret` · `secret-proofs` · `steps` · `strip` · `proofs` · `generator-map` · `mcp-template` · `security` · `self`<!--/n-->
...
llama `verificar.yml`. **`rebar novo` murió con ENOENT** — y `npm run verify` siguió en verde
...
Lleva <!--n mcp.artefato.regras-->26<!--/n--> reglas de dos módulos, <!--n mcp.artefato.passos-->18<!--/n--> pasos de compuerta y <!--n mcp.artefato.provas-->59<!--/n--> pruebas, expuestos en <!--n mcp.ferramentas-->5<!--/n--> herramientas.

## Mapa del repositorio

| Ruta | Qué |
|---|---|
| `tooling/rebar-check/` | la regla de formato y sus <!--n proofs.casos-->55<!--/n--> casos de prueba |

...
`tooling/rebar-check/index.mjs`, <!--n lines.rebar-check-->2.980<!--/n--> lines.
...
### 4.3 PROVEN · The proofs — <!--n proofs.casos-->58<!--/n--> cases, <!--n proofs.cobertura-->23 de 23<!--/n--> rules

_Remeasured on 31/08/2026 · numbers derived since 02/09/2026._

There are <!--n proofs.casos-->58<!--/n--> cases and <!--n proofs.regras-com-prova-->23<!--/n--> rules with proof — coverage <!--n proofs.cobertura-->23 de 23<!--/n-->, with no uncovered rule. The runner counts the folders
...
Of the <!--n proofs.casos-->58<!--/n-->, **two are from 31/08 and lock the template exclusion**
...
### 4.4 PROVEN · `verificar` — <!--n verify.passos-->20<!--/n--> steps

_Remeasured on 02/09/2026. This file said "8 of 8" and the README said "the 8 steps"; there
were 12 when the count was redone, and there are <!--n verify.passos-->20<!--/n--> now. The
...
On 02/09/2026: **APROVADO <!--n verify.passos-->20<!--/n--> de <!--n verify.passos-->20<!--/n--> passos · 22,3 s · exit 0.** The duration varies with the
...
| --- | --- | --- |
| `blocos` | <!--n verify.posicao.blocks-->5 de 20<!--/n--> | syntax and `modelo.json` of the files the generator copies into every created project — a defect here is born replicated in all of them |
| `mcp-servidor` | <!--n verify.posicao.mcp-server-->6 de 20<!--/n--> | the MCP server **comes up and answers the protocol**. Without `mcp/node_modules` the step BREAKS (127), it does not fail: missing tooling is not the repository erring |
| `mcp` | <!--n verify.posicao.mcp-->7 de 20<!--/n--> | the MCP artifact diverging from the source — §4.12 |
| `numeros` | <!--n verify.posicao.numbers-->8 de 20<!--/n--> | a number in this file or in the README diverging from the source — §0 |
| `passos` | <!--n verify.posicao.steps-->13 de 20<!--/n--> | the steps that are the **function** of the gate, proven by mutation. `checarBlocos` came in with 410 lines and zero tests, and swapping the body for `return { codigo: 0 }` kept `verificar` APROVADO |
...
| Piece                     | What it is                                                              |
| ------------------------- | ----------------------------------------------------------------------- |
| `tooling/rebar-check/index.mjs` | **The source.** <!--n lines.rebar-check-->2.980<!--/n--> lines, <!--n rules.total-->23<!--/n--> rules, with the measured why of each one |
| `mcp/generate.mjs`           | **The generator.** <!--n lines.mcp-gerador-->1.072<!--/n--> lines, **zero dependency** |
| `mcp/rules.generated.json`  | **The artifact.** <!--n mcp.artefato.tamanho-->107 KB<!--/n--> · <!--n mcp.artefato.regras-->26<!--/n--> rules · <!--n mcp.artefato.niveis-->8<!--/n--> levels · <!--n mcp.artefato.passos-->20<!--/n--> steps · <!--n mcp.artefato.provas-->62<!--/n--> proofs |
...
`node mcp/generate.mjs` — **one command** — and `verificar` goes back to PASSING the <!--n verify.passos-->20<!--/n--> steps.
...
stays by hand, with the date (§0). It is the <!--n verify.posicao.mcp-->7 de 20<!--/n--> of
...
| ----------------------------------------------------- | ------------------------------------------------------------------------------ |
| `verificar/verificar.mjs`                             | **PRESENT.** 34.566 bytes, tracked. Rewritten, not ported. Today with <!--n verify.passos-->20<!--/n--> steps |
...
<!--n verify.passos-->20<!--/n--> steps
in `verificar`, <!--n proofs.casos-->58<!--/n--> cases in `provar`, <!--n domain.privilegio.testes-->16<!--/n--> assertions in the privilege domain, and 56
...
n/a** (§4.2), `verificar` closes <!--n verify.passos-->20<!--/n--> of <!--n verify.passos-->20<!--/n--> steps, the proofs are <!--n proofs.casos-->58<!--/n--> cases covering <!--n proofs.cobertura-->23 de 23<!--/n--> rules, the hooks are installed, twelve attacks

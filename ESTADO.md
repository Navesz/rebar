...
| `mcp/rules.generated.json`  | **O artefato.** <!--n mcp.artefato.tamanho-->91 KB<!--/n--> · <!--n mcp.artefato.regras-->26<!--/n--> regras · <!--n mcp.artefato.niveis-->8<!--/n--> níveis · <!--n mcp.artefato.passos-->16<!--/n--> passos · <!--n mcp.artefato.provas-->57<!--/n--> provas |
...
n/a** (§4.2), o `verificar` fecha <!--n verify.passos-->16<!--/n--> de <!--n verify.passos-->16<!--/n--> passos, as provas são <!--n proofs.casos-->54<!--/n--> casos cobrindo <!--n proofs.cobertura-->23 de 23<!--/n--> regras, os hooks estão instalados, doze ataques

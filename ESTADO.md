...
n/a** (§4.2), `verificar` closes <!--n verify.passos-->27<!--/n--> of <!--n verify.passos-->27<!--/n--> steps, the proofs are <!--n proofs.casos-->82<!--/n--> cases covering <!--n proofs.cobertura-->23 de 23<!--/n--> rules, the hooks are installed, twelve attacks

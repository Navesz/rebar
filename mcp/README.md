...
| `mcp/rules.generated.json` | **O artefato.** <!--n mcp.artefato.tamanho-->91 KB<!--/n-->. Não se edita à mão |
...
| `rebar_portao` | os <!--n mcp.artefato.passos-->16<!--/n--> passos do portão, o comando de cada um, os códigos de saída | quando o portão reprovar e a mensagem não bastar |

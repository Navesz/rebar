...
[![Rules](https://img.shields.io/badge/rules-38-blue)](#what-it-checks)
...
It carries <!--n mcp.artefato.regras-->38<!--/n--> rules from two modules, <!--n mcp.artefato.passos-->26<!--/n--> gate steps and <!--n mcp.artefato.provas-->175<!--/n--> proofs, exposed through <!--n mcp.ferramentas-->5<!--/n--> tools.

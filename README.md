...
It carries <!--n mcp.artefato.regras-->40<!--/n--> rules from two modules, <!--n mcp.artefato.passos-->27<!--/n--> gate steps and <!--n mcp.artefato.provas-->190<!--/n--> proofs, exposed through <!--n mcp.ferramentas-->5<!--/n--> tools.

...
There are <!--n proofs.casos-->82<!--/n--> cases, one pair per rule, and all <!--n rules.total-->23<!--/n--> rules are covered:
...
| Path | What |
|---|---|
| `tooling/rebar-check/` | the format ruler and its <!--n proofs.casos-->82<!--/n--> proof cases |

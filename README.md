...
It carries <!--n mcp.artefato.regras-->26<!--/n--> rules from two modules, <!--n mcp.artefato.passos-->19<!--/n--> gate steps and <!--n mcp.artefato.provas-->61<!--/n--> proofs, exposed through <!--n mcp.ferramentas-->5<!--/n--> tools.

...
[![Gate](https://img.shields.io/badge/gate-<!--n verify.passos-->19<!--/n-->%20steps-blue)](#the-gate)
...
There are <!--n proofs.casos-->55<!--/n--> cases, one pair per rule, and all <!--n rules.total-->23<!--/n--> rules are covered:
...
it, today with <!--n verify.passos-->19<!--/n--> steps.

In order: <!--n verify.lista-passos-->`hygiene` · `hooks` · `commit-msg` · `syntax` · `blocks` · `mcp-server` · `mcp` · `numbers` · `format` · `links` · `secret` · `secret-proofs` · `steps` · `strip` · `proofs` · `generator-map` · `mcp-template` · `security` · `self`<!--/n-->
...
It carries <!--n mcp.artefato.regras-->26<!--/n--> rules from two modules, <!--n mcp.artefato.passos-->19<!--/n--> gate steps and <!--n mcp.artefato.provas-->59<!--/n--> proofs, exposed through <!--n mcp.ferramentas-->5<!--/n--> tools.

## Repository map

| Path | What |
|---|---|
| `tooling/rebar-check/` | the format ruler and its <!--n proofs.casos-->55<!--/n--> proof cases |

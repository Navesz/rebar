...
There are <!--n proofs.casos-->74<!--/n--> cases, one pair per rule, and all <!--n rules.total-->23<!--/n--> rules are covered:
...
It carries <!--n mcp.artefato.regras-->40<!--/n--> rules from two modules, <!--n mcp.artefato.passos-->27<!--/n--> gate steps and <!--n mcp.artefato.provas-->192<!--/n--> proofs, exposed through <!--n mcp.ferramentas-->5<!--/n--> tools.

## Repository map

| Path | What |
|---|---|
| `tooling/rebar-check/` | the format ruler and its <!--n proofs.casos-->74<!--/n--> proof cases |

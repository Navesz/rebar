 ...
 *
 * Existe para o `new/index.mjs` poder transformar a dívida em AVISO e, com
 ...
 * preset é chamado sozinho (`node new/site/aplicar.mjs ...`), que é como o
...
export function aplicarSite({ destino, nome, dominio, agora, silencioso = false }) {
  ...
  //    em tooling/rebar-check/index.mjs). Copiado, ele viraria um arquivo

...
Documento lido na íntegra (757 linhas). Evidência de terceiros re-conferida por amostragem no código instalado em `~/OneDrive/Documents/prumo/node_modules` e nos dois repositórios de referência; os itens re-conferidos estão marcados **[reverificado]**.

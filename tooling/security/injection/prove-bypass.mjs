...
test('workflows fail, gh-aw lock files warn, and full-auto is no bypass', () => {
  ...
  const lock = cabecalho + passo(`${CO} exec ${SEM_APROVACAO} "x"`)
...
test('the approval inputs of the Codex and Claude actions are read as the command they run (backlog 11)', () => {
  ...
  const lock = veredito({
    '.github/workflows/agent.lock.yml': workflow(ACAO_CODEX, [`sandbox: ${SEM_SANDBOX}`], {
      cabecalho: '# This file was automatically generated by gh-aw. DO NOT EDIT.\n',
    }),
  })

// emoji-17 - every RGI emoji sequence that carries a joiner, a selector or a tag,
// as numbers, from the Unicode 17.0 emoji files. prove-unicode.mjs feeds each one
// to hidden-unicode under every file type and requires zero findings: the rule's
// emoji exceptions are measured against the whole standard, not against a few
// examples. unicode.mjs also reads SEQUENCIAS_DE_TAG, so the only tag code points
// it ever exempts are the ones inside these exact flags.
//
// Numbers only: this file holds no raw emoji, joiner or tag character.
// Generated once by a script kept outside the repository.

/**
 * RGI_Emoji_ZWJ_Sequence - emoji-zwj-sequences.txt (2025-01-08, 04:57:12 GMT),
 * sha256 5b25441daed2322b068c5e70cda522946a4f0274df864445a1965a92e5fc5cad.
 * 1614 sequences.
 */
export const SEQUENCIAS_ZWJ = [
...
/**
 * Emoji_Keycap_Sequence - emoji-sequences.txt (2025-07-25, 17:54:32 GMT),
 * sha256 12cc8267dc33cbd11ed32bcf6fc5dc2ad9c7a77bae1bdfba2f41b1b9b3ead8dd.
 * 12 sequences: [#*0-9], U+FE0F, U+20E3.
 */
export const SEQUENCIAS_DE_TECLA = [
  [0x23, 0xfe0f, 0x20e3],
  [0x2a, 0xfe0f, 0x20e3],
  [0x30, 0xfe0f, 0x20e3],
  [0x31, 0xfe0f, 0x20e3],
...
/** RGI_Emoji_Flag_Sequence - the same file. 259 pairs of regional indicators. */
export const SEQUENCIAS_DE_BANDEIRA = [
  [0x1f1e6, 0x1f1e8],
  [0x1f1e6, 0x1f1e9],
  [0x1f1e6, 0x1f1ea],
  [0x1f1e6, 0x1f1eb],
...
/**
 * RGI_Emoji_Tag_Sequence - the same file. The 3 subdivision flags, the only
 * tag sequences in the standard.
 */
export const SEQUENCIAS_DE_TAG = [
...
/**
 * Basic_Emoji entries of the same file that end in U+FE0F: 207 text-default
 * pictographs shown as emoji.
 */
export const EMOJI_COM_SELETOR = [
  [0xa9, 0xfe0f],
  [0xae, 0xfe0f],
  [0x203c, 0xfe0f],
  [0x2049, 0xfe0f],
